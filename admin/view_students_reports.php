...
<html>
<head>
<title>ATU ILMS | View Student Reports</title>
					...
					<div class="col-md-12 panel-grids">
							<div class="panel panel-primary"> 
								<div class="panel-heading"> 
									<h3 class="panel-title">View Student Reports</h3> 
								</div> 
										   ...
										   <table class="table table-bordered table-condensed">
											   <thead>
												   <tr>
													   ...
													   <th class="text-center" scope="col" colspan="4"><b>CHAPTERS</b></th>
												   </tr>
											   </thead>
											   <tbody>
												   <tr>
													   ...
													   <th class="text-center" scope="row"></th>
													   <th class="text-center" scope="row">Chapter: 1</th>
													   <th class="text-center" scope="row">Chapter: 2</th>
													   <th class="text-center" scope="row">Chapter: 3</th>
													   <th class="text-center" scope="row">Chapter: 4</th>
												   </tr>
												   ...
												   <tr>
													   ...
													   <td>
														<div class="form-group">
															<textarea name="View_Report" class="form-control" rows="5" cols="150" readonly></textarea>
														</div>
													   </td>
													   <td>
															<div class="form-group">
												   ...
												   <tr>
													...
													<td>
													 <div class="form-group">
														 <textarea name="Introduction" class="form-control" rows="5" cols="150" readonly></textarea>
													 </div>
													</td>
													<td>
														 <div class="form-group">
