											 ...
											 <div class="panel-body e-logbook-panel widget_shadow_panel"> 
													...
													<div class="row">
															<div class="col-sm-4 col-md-4 col-lg-4">
																<a class="btn btn-primary btn-sm disabled" id="e-logbook-btn" href="#" role="button"> 
															...
															<div class="col-sm-4 col-md-4 col-lg-4">
																<h4 class="" id="weeks-header">Week 1</h4>
															</div>
															<div class="col-sm-4 col-md-4 col-lg-4">
																<a class="btn btn-primary btn-sm px-3" id="e-logbook-btn" href="e_logbook_2.php" role="button">
																	Next
