<?php 
	...
	$programs = array("--Select Program--","Accountancy","Building Technology","Civil Engineering","Computer Science",
	"Electrical / Electronics Engineering","Fashion Design & Textiles","Furniture Design & Production","Hotel, Catering & Institutional Management",
	"Languages & Liberal Studies","Mathematics & Statistics","Marketing","Mechanical Engineering","Purchasing & Supply","Science Laboratory Technology",
...
<html>
<head>
<title>ATU ILMS | Virtual Attachment Registration</title>
                         ...
                         <div class="col-md-12 panel-grids">
                                 <div class="panel panel-primary"> 
                                     <div class="panel-heading"> 
                                         <h3 class="panel-title">Virtual Attachment Registration</h3> 
									 </div> 
                                     ...
                                     <div class="panel-body"> 
												...
												<div class="row">
													<form class="form-inline "  action="" method="POST"> 
														<div class="form-group"> 
															<input type="text" class="form-control" name="inputReceiptNumber" id="inputReceiptNumber" pattern="[0-9]{10}" title="(Receipt number must contain 10 digits)" placeholder="Enter Receipt Number" onkeypress="return number(event)" required> 
														</div> 
																
														<button type="submit" class="btn btn-default btn-sm" name="validate_btn">Validate</button> 
													</form>
												</div>
											</div>
											<!--// Validation Form -->
										...
										<form  action="" method="POST">
											...
											<div class="text-center">
												<button type="submit" class="btn btn-default" <?php echo $submitStatus; ?> name="register_btn">Register</button>
											</div> 
										</form>
										</div>
