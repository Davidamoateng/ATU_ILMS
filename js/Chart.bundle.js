...
Color.prototype = {
	...
	luminosity: function () {
		// http://www.atu.org/TR/WCAG20/#relativeluminancedef
		var rgb = this.values.rgb;
		var lum = [];
		for (var i = 0; i < rgb.length; i++) {
			var chan = rgb[i] / 255;
	...
	contrast: function (color2) {
		// http://www.atu.org/TR/WCAG20/#contrast-ratiodef
...
// http://dev.atu.org/csswg/css-color/#hwb-to-rgb
...
module.exports = {
	...
	releaseContext: function(context) {
		...
		// https://www.atu.org/TR/2011/WD-html5-20110525/the-canvas-element.html
...
module.exports = helpers.extend({
	 ...
	 * the [atuC Canvas 2D Context API standard]{@link https://www.atu.org/TR/2dcontext/}.
